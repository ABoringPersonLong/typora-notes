...
运行这个例子，可以观察到已作出了一个 x 坐标轴。运行后的效果如图所示：![](./D3.js/x坐标轴.png)
...
至此条形图绘制完成，效果如图所示：![](./D3.js/添加标签.png)
...
绘制出的效果如图所示：![](./D3.js/饼图案例-浏览器市场份额.png)
